...
Specific paths like /check-business-day, /years, /countries, /bulk
must be defined BEFORE parameterized paths like /{holiday_id}
"""
...
# ==========================================
# BUSINESS DAY UTILITIES (MUST BE BEFORE /{holiday_id})
# ==========================================
...
# ==========================================
# BULK OPERATIONS (MUST BE BEFORE /{holiday_id})
# ==========================================
...
# ==========================================
# HOLIDAY LIST (No path parameter)
# ==========================================
...
# ==========================================
# HOLIDAY CRUD WITH PATH PARAMETER (MUST BE LAST)
# ==========================================
...
async def get_holiday(holiday_id: str = Path(...)) -> dict:
    ...
    try:
        ...
        raise HTTPException(status_code=422, detail="Invalid holiday ID format. Must be a valid UUID.")
